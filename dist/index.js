...
var fsy = ['italic', 'normal'];
var fw = [400, 500, 600, 700, 800, 900];
var fontFamilys = ['宋体', '微软雅黑', '楷体', 'Arial', 'Verdana', 'Fixedsys', 'impact', '华文黑体', 'Lobster', 'Ink free', 'Segoe UI', 'PingFang SC', 'Hiragino Sans GB', 'Microsoft YaHei', 'Helvetica Neue', 'Helvetica', 'sans-serif', 'Microsoft jhengHei', 'Segoe UI Emoji', 'Segoe UI Symbol'];

var MontageInput = function (_React$Component) {
    _inherits(MontageInput, _React$Component);

    function MontageInput(props) {
        _classCallCheck(this, MontageInput);

        var _this = _possibleConstructorReturn(this, (MontageInput.__proto__ || Object.getPrototypeOf(MontageInput)).call(this, props));
        ...
        _this.onClick = function () {
            _this.setState({ montages: _this.createMontage(_this.state.value) });
        };

        _this.createMontage = function (value) {
            var arr = value.split("");
            var montages = [];
            arr.forEach(function (element) {
                var montage = _react2.default.createElement(
                    'span',
                    { style: {
                            color: _this.color16(),
                            fontSize: parseInt(Math.random() * (_this.sizeMax - _this.sizeMin + 1) + _this.sizeMin, 10),
    ...
    _createClass(MontageInput, [{
        key: 'color16',
        value: function color16() {
            //十六进制颜色随机
        ...
        value: function render() {
            return _react2.default.createElement(
                'div',
                null,
                _react2.default.createElement('input', { onChange: this.onChange.bind(this) }),
